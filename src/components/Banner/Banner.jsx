    ...
    return (
        <div className='lg:flex lg:px-36 items-center gap-10 mt-10'>
            <div className='lg:w-[50%] lg:px-0 px-6'>
                <h1 className='text-5xl font-bold mb-1'>Thai <span className='text-yellow-400 hover:text-yellow-300'>Super</span> Food</h1>
                ...
                <button className='bg-yellow-400 hover:bg-yellow-300 w-full text-white px-6 py-2 lg:mb-0 mb-4 rounded-lg font-semibold mt-2'>See More</button>
            </div>
            <div>
