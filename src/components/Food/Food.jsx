        ...
        <div className='lg:mt-24 divide-y divide-red-600 mt-10 lg:px-36 px-6'>
            ...
            <div className='lg:grid grid-cols-3 gap-10'>
                <div className='mt-10 border border-red-600 rounded-lg p-5 text-center'>
                    ...
                    <button className='mt-2 bg-yellow-400 p rounded-2xl text-center left-24 text-white px-10 hover:bg-yellow-300 py-3 text-2xl'>Cake</button>
                </div>
                <div className='mt-10  border border-red-600 rounded-lg p-5 text-center'>
                    ...
                    <button className='mt-2 hover:bg-yellow-300 bg-yellow-400 p rounded-2xl text-center left-24 text-white px-10 py-3 text-2xl'>Burger</button>
                </div>
                <div className='mt-10 border border-red-600 rounded-lg p-5 text-center'>
                    ...
                    <button className='mt-2 bg-yellow-400 p rounded-2xl text-center left-24 hover:bg-yellow-300 text-white px-10 py-3 text-2xl'>Chicken</button>
                </div>
                <div className='mt-10  border border-red-600 rounded-lg p-5 text-center'>
                    <img className='w-96 transform hover:rotate-2 rounded-full' src="https://images.unsplash.com/photo-1499028344343-cd173ffc68a9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fGZvb2R8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" />
                    <button className='mt-2 hover:bg-yellow-300 bg-yellow-400 p rounded-2xl text-center left-24 text-white px-10 py-3 text-2xl'>Burger</button>
